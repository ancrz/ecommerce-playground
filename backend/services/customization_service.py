...
from ..models.base import Customization, BaseModel
...
class CustomizationService:
    ...
    async def update_customization(self, updates: CustomizationUpdate) -> Customization:
        ...
        db_columns = [
            ...
            "icon_products_url", "icon_business_url", "icon_customization_url",
            "icon_finance_url", "icon_sales_url", "icon_users_url", "icon_tax_url", "updated_at"
        ]
    ...
    async def upload_module_icon(self, module_name: str, file_data: bytes, original_filename: str) -> Customization:
        ...
        """
        valid_modules = [
            "products", "business", "customization", "finance", "sales", "users", "tax"
        ]

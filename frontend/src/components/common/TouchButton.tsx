...
export const TouchButton: React.FC<TouchButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-white hover:bg-gray-50 active:bg-gray-100 text-gray-700 border border-gray-300 rounded-lg',
    ghost: 'bg-transparent hover:bg-gray-100 active:bg-gray-200 text-gray-700 rounded-lg',
    outline: 'bg-transparent border border-gray-300 hover:bg-gray-50 text-gray-700 rounded-lg',
  };
